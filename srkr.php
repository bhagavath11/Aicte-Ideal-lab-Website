...
<html lang="zxx">
    ...
    <body>
	   ...
	   ?>
            ...
            <div class="container">
                <h2>Idea Lab<span class="theme-cl"></span></h2>
                <p>
                    VISION:
Sagi Rama Krishnam Raju Engineering College will be offering Engineering and Technology Programs of choice, where parents want to send their children, where students want to learn, where employers seek Quality Engineers and Technologists, where Industry and Government find Technological Innovations..

MISSION:
Eminence in Technical Education through the quality of programs, teaching and research with social relevance.

QUALITY POLICY:
The College is committed to achieve Excellence in Teaching, Research and Consultancy By imparting Globally, focused education to create world class professionals By establishing harmonious relationships with Industry and Society By developing state of the art Infrastructure and well endowed Faculty By imparting knowledge through team work.
                </p>
