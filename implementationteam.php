			...
			<div class="row justify-content-center">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="sec-heading center">
                                <h2> <span class="theme-cl">Implementation Team</span></h2>
							...
							<div class="crs_grid_list">
								...
								<div class="crs_grid_list_thumb">
									<a href=""><img src="assets/img/ceo.png" class="img-fluid rounded" alt=""></a>
								</div>
								
								<div class="crs_grid_list_caption">
									<div class="crs_lt_101">
										<!-- <span class="est st_1"></span> -->
										<!-- <span class="est st_2">Technology</span>  -->
									</div> 
                                    
									<div class="crs_lt_102">
										<h2 class="crs_tit">S.R.K.Nishant Varma </h2>
										<h6><span class="crs_auth">CEO</span></h6>
							...
							<div class="crs_grid_list">
								...
								<div class="crs_grid_list_thumb">
									<a href=""><img src="assets/img/Picture1.jpg" class="img-fluid rounded" alt=""></a>
								</div>
								
								<div class="crs_grid_list_caption">
									<div class="crs_lt_101">
										<span class="est st_1">Cheif Mentor</span>
										<!-- <span class="est st_2">Technology</span>  -->
									</div> 
                                    
									<div class="crs_lt_102">
										<h2 class="crs_tit">Dr. M. Jagapathi Raju </h2>
										<h6><span class="crs_auth">Principal</span></h6>
                                       <!-- <h6> Publish date : <span class="crs_auth">10/04/2003</span></h6>
                                        <h6>Author's :<span class="crs_auth"> 1. Names </span><br></h6>
                                       <h6> Approval By  : <span class="crs_auth"> 1. Names </span></h6> -->
							...
							<div class="crs_grid_list">
								...
								<div class="crs_grid_list_thumb">
									<a href="course-detail.html"><img src="assets/img/Picture2.jpg" class="img-fluid rounded" alt=""></a>
								</div>
								
								<div class="crs_grid_list_caption">
									<div class="crs_lt_101">
										<span class="est st_1">Faculty Coordinator</span>
										<!-- <span class="est st_2">Technology</span>  -->
									</div> 
                                    
									<div class="crs_lt_102">
										<h2 class="crs_tit">Dr. N. Gopala Krishna Murthy   </h2>
										<h6><span class="crs_auth">Head-Technology Centre & Associate Professor</span></h6>
                                       <!-- <h6> Publish date : <span class="crs_auth">10/04/2003</span></h6>
                                        <h6>Author's :<span class="crs_auth"> 1. Names </span><br></h6>
                                       <h6> Approval By  : <span class="crs_auth"> 1. Names </span></h6> -->
                            ...
                            <!-- <div class="crs_grid_list">
								...
								<div class="crs_grid_list_caption">
									...
									<div class="crs_lt_102">
										<h2 ="crs_tit">Dr. M. Jagapathi Raju </h2>
										<h6><span class="crs_auth">Principal</span></h6>
                                       <!-- <h6> Publish date : <span class="crs_auth">10/04/2003</span></h6>
                                        <h6>Author's :<span class="crs_auth"> 1. Names </span><br></h6>
                                       <h6> Approval By  : <span class="crs_auth"> 1. Names </span></h6> 
