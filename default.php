...
<html lang="zxx">
    ...
    <body>
		...
		?>
			...
			<!-- ============================ Hero Banner  Start================================== -->
			<div class="hero_banner image-cover image_bottom" style="background:#f7f8f9  no-repeat;">
				<div class="container">
									...
									<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                          ...
                                          <div class="carousel-item">
                                            <img src="https://th.bing.com/th/id/R.021c21780fb4f626988cb4973c8f3294?rik=A3o1L7KLRlN51A&riu=http%3a%2f%2fwww.etilabs.com%2fwp-content%2fuploads%2f2019%2f04%2fsrkr-logo.png&ehk=skagxYa%2feQnnl9EhFSR6hbUmOdxCpY0vAnBGbMQDCh4%3d&risl=&pid=ImgRaw&r=0" class="d-block w-100" alt="...">
                                          </div>
                                          <div class="carousel-item">
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-10 text-center">
							<div class="sec-heading center mb-4">
								<h2> In  <span class="theme-cl">Aicte Lab</span></h2>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="edu_cat_2 cat-2">
								...
								<div class="edu_cat_data">
									<h4 class="title"><a href="#">Patents</a></h4>
									<ul class="meta">
										<li class="video">coming soon</li>
									</ul>
								</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="edu_cat_2 cat-6">
								...
								<div class="edu_cat_data">
									<h4 class="title"><a href="#">Utilization</a></h4>
									<ul class="meta">
										<li class="video">Industry | Students | Startup |Alumini </li>
									</ul>
								</div>
							</div>							
						</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_cates cl_1"><span>Banking</span></div>
										</div>
										<div class="crs_fl_last">
											<div class="crs_inrolled"><strong>7,150</strong>Enrolled</div>
										</div>
									</div>
									...
									<div class="crs_info_detail">
										<ul>
											<li><i class="fa fa-clock text-danger"></i><span>05 hr 07 min</span></li>
											<li><i class="fa fa-video text-success"></i><span>22 Lectures</span></li>
											<li><i class="fa fa-signal text-warning"></i><span>Beginer</span></li>
										</ul>
									</div>
								</div>
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.html"><img src="assets/img/team-5.jpg" class="img-fluid circle" alt=""></a></div><div class="crs_tutor_name"><a href="instructor-detail.html">Robert Fox</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_cates cl_4"><span>Development</span></div>
										</div>
										<div class="crs_fl_last">
											<div class="crs_inrolled"><strong>1,250</strong>Enrolled</div>
										</div>
									</div>
									...
									<div class="crs_info_detail">
										<ul>
											<li><i class="fa fa-clock text-danger"></i><span>07 hr 05 min</span></li>
											<li><i class="fa fa-video text-success"></i><span>42 Lectures</span></li>
											<li><i class="fa fa-signal text-warning"></i><span>Beginer</span></li>
										</ul>
									</div>
								</div>
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.html"><img src="assets/img/user-4.jpg" class="img-fluid circle" alt=""></a></div><div class="crs_tutor_name"><a href="instructor-detail.html">Robert Fox</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_cates cl_5"><span>Physics</span></div>
										</div>
										<div class="crs_fl_last">
											<div class="crs_inrolled"><strong>8,350</strong>Enrolled</div>
										</div>
									...
									<div class="crs_info_detail">
										<ul>
											<li><i class="fa fa-clock text-danger"></i><span>05 hr 10 min</span></li>
											<li><i class="fa fa-video text-success"></i><span>61 Lectures</span></li>
											<li><i class="fa fa-signal text-warning"></i><span>Beginer</span></li>
										</ul>
									</div>
								</div>
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.html"><img src="assets/img/user-3.jpg" class="img-fluid circle" alt=""></a></div><div class="crs_tutor_name"><a href="instructor-detail.html">Robert Fox</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_cates cl_6"><span>Maths</span></div>
										</div>
										<div class="crs_fl_last">
											<div class="crs_inrolled"><strong>3,340</strong>Enrolled</div>
										</div>
									</div>
									...
									<div class="crs_info_detail">
										<ul>
											<li><i class="fa fa-clock text-danger"></i><span>10 hr 12 min</span></li>
											<li><i class="fa fa-video text-success"></i><span>43 Lectures</span></li>
											<li><i class="fa fa-signal text-warning"></i><span>Beginer</span></li>
										</ul>
									</div>
								</div>
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.html"><img src="assets/img/user-2.jpg" class="img-fluid circle" alt=""></a></div><div class="crs_tutor_name"><a href="instructor-detail.html">Robert Fox</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
											<div class="crs_price"><h2><span class="currency">$</span><span class="theme-cl">119</span></h2></div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_cates cl_7"><span>History</span></div>
										</div>
										<div class="crs_fl_last">
											<div class="crs_inrolled"><strong>6,450</strong>Enrolled</div>
										</div>
									</div>
									...
									<div class="crs_info_detail">
										<ul>
											<li><i class="fa fa-clock text-danger"></i><span>07 hr 15 min</span></li>
											<li><i class="fa fa-video text-success"></i><span>57 Lectures</span></li>
											<li><i class="fa fa-signal text-warning"></i><span>Beginer</span></li>
										</ul>
									</div>
								</div>
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.html"><img src="assets/img/user-1.jpg" class="img-fluid circle" alt=""></a></div><div class="crs_tutor_name"><a href="instructor-detail.html">Robert Fox</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="blg_grid_box">
								<div class="blg_grid_thumb">
									<a href=""><img src="assets/img/sample.png" class="img-fluid" alt=""></a>
								</div>
								<div class="blg_grid_caption">
									<!-- <div class="blg_tag"><span>Marketing</span></div> -->
									<div class="blg_title"><h4><a href="">Acite idea Lab</a></h4></div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="blg_grid_box">
								...
								<div class="blg_grid_caption">
									...
									<div class="blg_title"><h4><a href="">Aicte idea Lab</a></h4></div>
									<div class="blg_desc"><p>AICTE IDEA labs to foster creativity, experiential
										learning on campus
										</p></div>
								</div>
