						...
						<div class="row">
							...
							<div class="col-lg-5 col-md-5">
								<div class="footer_widget">
									<img src="assets/img/smaplelogo.png" class="img-footer small mb-2" alt="">
									<h4 class="extream mb-3">Srkrec Idea Lab</h4>
									<p>Sagi Rama Krishnam Raju Engineering College (SRKREC), established in 1980, is a self-financed academic institution of coeducation striving to provide a high quality technical education to engineering aspirants. Being one of the premier and well-established technical institutions of the country, it continues to render service to the nation and the world at large with its alumni holding highly prestigious positions and making substantial contribution.</p>
								...
								<div class="row">
									...
									<div class="col-lg-4 col-md-4">
										<div class="footer_widget">
											...
											<ul class="footer-menu">
												<li><a href="idealab.php">Idea Lab</a></li>
												<li><a href="https://idealnet.aicte-india.org/">Aicte</a></li>
												<li><a href="leadershipteam.php">Leaderrship team</a></li>
												<li><a href="#">National Streaming Committe</a></li>
												<!-- <li><a href="#">Login</a></li> -->
												<li><a href="contact.php">Contact Deatails</a></li>
					...
					<div class="container">
						<div class="row align-items-center">
							<div class="col-lg-12 col-md-12 text-center">
								<!-- <p class="mb-0">© 2021 SkillUp. Designd By <a href="#">------</a>.</p> -->
							</div>
						</div>
					</div>
				</div>
